...
const ACCEPTED = '.mp4,.mkv,.avi,.mov,.webm,.mp3,.wav,.m4a,.ogg,.flac,.aac,.txt'
...
export default function UploadCard({ onUpload, disabled }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-lg font-semibold text-amber-100">Drop your video, audio, or text here</p>
      <p className="text-xs text-orange-700 tracking-widest mt-1 select-none">「動画・音声・テキストを選べ」</p>
      <p className="text-sm text-amber-800 mt-1">MP4, MKV, MOV, MP3, WAV · TXT (English text)</p>
      <button
